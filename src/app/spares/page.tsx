      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight mt-4 uppercase">
            Sanitary <span className="text-yellow-400">Spares</span> & <span className="text-emerald-400">Components Gallery</span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {spares.map((spare) => (
            <motion.div
              ...
              className="rounded-2xl overflow-hidden glass-panel border border-white/5 hover:border-orange-400/40 shadow-lg hover:shadow-orange-500/10 cursor-pointer flex flex-col justify-between group transition-all duration-300"
            >
              {/* Image Area */}
